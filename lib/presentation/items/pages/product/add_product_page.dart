...
class _AddProductPageState extends State<AddProductPage> {
  ...
  void initState() {
    ...
    // Auto-formatting for currency inputs
    _priceController.addListener(() => _formatCurrency(_priceController));
    _costController.addListener(() => _formatCurrency(_costController));
  }

  void _formatCurrency(TextEditingController controller) {
    final nominal = controller.text.replaceAll(RegExp(r'[^0-9]'), '');
    if (nominal.isEmpty) return;
    final formatted = nominal.currencyFormatRp;
