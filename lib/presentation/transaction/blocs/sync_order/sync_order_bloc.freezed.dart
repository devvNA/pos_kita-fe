...
/// @nodoc
abstract class _$$SyncAllImplCopyWith<$Res> {
  factory _$$SyncAllImplCopyWith(
    _$SyncAllImpl value,
    $Res Function(_$SyncAllImpl) then,
  ) = __$$SyncAllImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$SyncAllImplCopyWithImpl<$Res>
    extends _$SyncOrderEventCopyWithImpl<$Res, _$SyncAllImpl>
    implements _$$SyncAllImplCopyWith<$Res> {
  __$$SyncAllImplCopyWithImpl(
    _$SyncAllImpl _value,
    $Res Function(_$SyncAllImpl) _then,
  ) : super(_value, _then);
...
class _$SyncAllImpl implements _SyncAll {
  const _$SyncAllImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$SyncAllImpl);
  }
...
abstract class _SyncAll implements SyncOrderEvent {
  const factory _SyncAll() = _$SyncAllImpl;
}
...
class __$$ProgressImplCopyWithImpl<$Res>
    extends _$SyncOrderStateCopyWithImpl<$Res, _$ProgressImpl>
  ...
  @override
  $Res call({Object? synced = null, Object? total = null}) {
    return _then(
      _$ProgressImpl(
        synced: null == synced
            ? _value.synced
...
class _$ProgressImpl implements _Progress {
  const _$ProgressImpl({required this.synced, required this.total});
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return progress?.call(synced, total);
  }
...
abstract class _Progress implements SyncOrderState {
