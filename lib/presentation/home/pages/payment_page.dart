...
import 'package:pos_kita/presentation/home/pages/invoice_offline_page.dart';
import 'package:pos_kita/presentation/home/pages/invoice_page.dart';
...
class _PaymentPageState extends State<PaymentPage> {
    ...
    nominalController.addListener(() {
      ...
      nominalController.value = TextEditingValue(
        ...
        selection: TextSelection.collapsed(
          offset: nominal.currencyFormatRp.length,
        ),
      );
    });
  }
  ...
  Future<void> _submitPayment({
    ...
    final bool isOnline = context.read<OnlineCheckerBloc>().state.maybeWhen(
      online: () => true,
      orElse: () => false,
    );
    ...
    if (isOnline) {
      ...
      context.read<OrderOfflineBloc>().add(
        OrderOfflineEvent.createOfflineOrder(orderRequestModel: request),
      );
    }
  }
}
