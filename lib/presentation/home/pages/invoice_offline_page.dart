...
class InvoiceOfflinePage extends StatefulWidget {
  // final List<ProductQtyModel> orders;
  final double nominal;
  final double totalPrice;
  final TransactionModel transaction;

  const InvoiceOfflinePage({
    super.key,
  ...
  @override
  State<InvoiceOfflinePage> createState() => _InvoiceOfflinePageState();
}

class _InvoiceOfflinePageState extends State<InvoiceOfflinePage> {
